    ...
    <main>
        ...
        <section class="py-20">
            <div class="container mx-auto px-6 md:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8"><a href="#" class="group block"><div class="bg-gray-100 aspect-square flex items-center justify-center p-4"><img src="{{ asset('images/watch-1.png') }}" alt="Aeronaut Pilot" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-105"></div><p class="mt-4 text-base text-gray-800">Aeronaut Pilot</p></a><a href="#" class="group block"><div class="bg-gray-100 aspect-square flex items-center justify-center p-4"><img src="{{ asset('images/watch-2.png') }}" alt="Stratos Diver" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-105"></div><p class="mt-4 text-base text-gray-800">Stratos Diver</p></a><a href="#" class="group block"><div class="bg-gray-100 aspect-square flex items-center justify-center p-4"><img src="{{ asset('images/watch-3.png') }}" alt="Heritage Classic" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-105"></div><p class="mt-4 text-base text-gray-800">Heritage Classic</p></a><a href="#" class="group block"><div class="bg-gray-100 aspect-square flex items-center justify-center p-4"><img src="{{ asset('images/watch-4.png') }}" alt="Urban Minimalist" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-105"></div><p class="mt-4 text-base text-gray-800">Urban Minimalist</p></a></div>
            </div>
        </section>
            ...
            <div class="container mx-auto px-6 md:px-8">
                <div class="flex flex-col lg:flex-row bg-stone-50">
                    ...
                    <div class="lg:w-1/2 flex flex-col justify-between p-12 md:p-20">
                        ...
                        <div class="flex justify-end pt-12"><div class="w-2/3 md:w-1/2"><a href="#" class="group"><div class="bg-gray-100 aspect-square"><img src="{{ asset('images/watch-5.png') }}" alt="Elegance Redefined Watch" class="w-full h-full object-contain p-4 transition-transform duration-300 group-hover:scale-105"></div></a></div></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="pb-20">
            <div class="container mx-auto px-6 md:px-8">
                <div class="flex justify-between items-baseline mb-8"><h3 class="font-serif text-3xl md:text-4xl uppercase tracking-wider">Follow Us</h3><a href="#" class="font-serif text-2xl md:text-3xl uppercase tracking-wider text-gray-800 hover:text-black">@watchstore.official</a></div>
